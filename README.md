...
This repository contains a collection of portfolio pages created by the Araneri team.
...
- The repository is currently structured as standalone HTML files.
- You can add a folder structure or a homepage later if you want to make it easier to navigate.
