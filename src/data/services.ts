...
export const services: readonly Service[] = [
  {
    title: "Arathadam",
    description: "A guided immersion into palm-leaf ritual design and mindful craft processes.",
  ...
  {
    title: "Kuralneri",
    description: "Story circles that translate oral histories into visual and sensory narratives.",
  ...
  {
    title: "Newsletter",
    description: "Seasonal transmissions of palm ecology, artisan updates, and new launches.",
